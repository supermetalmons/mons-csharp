...
public static class Config
{
    ...
    public static readonly Dictionary<Location, Square> Squares = new()
    {
        ...
        [new Location(0, 3)] = Square.MonBase(Mon.Kind.Mystic, Color.Black),
        [new Location(0, 4)] = Square.MonBase(Mon.Kind.Spirit, Color.Black),
        [new Location(0, 5)] = Square.MonBase(Mon.Kind.Drainer, Color.Black),
        [new Location(0, 6)] = Square.MonBase(Mon.Kind.Angel, Color.Black),
        [new Location(0, 7)] = Square.MonBase(Mon.Kind.Demon, Color.Black),

        [new Location(10, 3)] = Square.MonBase(Mon.Kind.Demon, Color.White),
        [new Location(10, 4)] = Square.MonBase(Mon.Kind.Angel, Color.White),
        [new Location(10, 5)] = Square.MonBase(Mon.Kind.Drainer, Color.White),
        [new Location(10, 6)] = Square.MonBase(Mon.Kind.Spirit, Color.White),
        [new Location(10, 7)] = Square.MonBase(Mon.Kind.Mystic, Color.White),
